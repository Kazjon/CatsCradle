...
def inception_v3(var_name, nlabels, images, pkeep, is_training):
    ...
    stddev=0.1
    checkpoint_var_name = "%sInceptionV3"%var_name
    output_name = "%soutput"%var_name
    weights_regularizer = tf.contrib.layers.l2_regularizer(weight_decay)
    with tf.variable_scope(checkpoint_var_name, checkpoint_var_name,\
        [images]) as scope:
    ...
    with tf.variable_scope(output_name) as scope:
