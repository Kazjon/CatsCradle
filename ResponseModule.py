...
class DummyResponseModule(object):
    ...
    def setEmotion(self, emotion, arg=None):
        ...
        if emotion == 'emotion0':
            ...
            self.action_module.moveTo('rest', 5)
        ...
        if emotion == 'emotion1':
            ...
            if not arg == None:
                ...
                if person.posCamera[0] < screenWidth/2:
                    self.action_module.moveTo('leftHandFullRaise', 5)
                else:
                    self.action_module.moveTo('rightHandFullRaise', 5)

        if emotion == 'emotion2':
            # Raise both arms, fast: 2 sec
            self.action_module.moveTo('bothHandFullRaise', 2)
