...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        sizer_22.Add(self.slider_h_speed, 0, wx.BOTTOM | wx.EXPAND | wx.TOP, 10)
        ...
        sizer_22.Add(self.slider_s_speed, 0, wx.BOTTOM | wx.EXPAND | wx.TOP, 10)
        ...
        self.slider_up_down = wx.Slider(self.notebook_1_Eyes, wx.ID_ANY, 0, -50, 50, style=wx.SL_LABELS | wx.SL_VERTICAL)
        self.slider_left_right = wx.Slider(self.notebook_1_Eyes, wx.ID_ANY, 0, -50, 50, style=wx.SL_HORIZONTAL | wx.SL_LABELS)
        self.button_close = wx.Button(self.notebook_1_Eyes, wx.ID_ANY, "CloseEye")
        self.button_open = wx.Button(self.notebook_1_Eyes, wx.ID_ANY, "OpenEye")
        self.button_blink = wx.Button(self.notebook_1_Eyes, wx.ID_ANY, "Blink")
        self.button_close.SetFont(wx.Font(40, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        self.button_open.SetFont(wx.Font(40, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        self.button_blink.SetFont(wx.Font(40, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        self.slider_up_down.SetFont(wx.Font(15, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        self.slider_left_right.SetFont(wx.Font(15, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, ""))
        sizer_3.Add(self.slider_up_down, 1, wx.EXPAND | wx.LEFT | wx.RIGHT, 30)
        sizer_3.Add(self.slider_left_right, 1, wx.BOTTOM | wx.EXPAND | wx.TOP, 30)
        sizer_2.Add(sizer_3, 1, wx.EXPAND, 0)
        sizer_4.Add(self.button_close, 1, wx.EXPAND, 0)
        sizer_4.Add(self.button_open, 1, wx.EXPAND, 0)
    ...
    def onMoveHead(self, event):
        ...
        speed = int(self.slider_h_speed.GetValue())
        print(speed)
        self.ac.rotateHead(pose, speed)
